...
Step-by-Step Process:
    ...
    Visualization & Communication:
        ...
        A four-panel figure was created to effectively communicate both the raw data and the statistical results:
            ...
            Raw median nitrate distribution.

            Nitrate values only in statistically significant areas.

            A classified hotspot/coldspot map.

            A diverging map of Z-scores, highlighting significance.
